...
RuboCop::AST::NodePattern::Sets::SET_MUST_BE_EMPTY_MUST_EQUAL_MUST_BE_CLOSE_TO_ETC = T.let(T.unsafe(nil), Set)

RuboCop::AST::NodePattern::Sets::SET_MUST_OUTPUT_MUST_RAISE_MUST_BE_SILENT_MUST_THROW = T.let(T.unsafe(nil), Set)
...
RuboCop::AST::NodePattern::Sets::SET___VALUE_EXPECT = T.let(T.unsafe(nil), Set)
